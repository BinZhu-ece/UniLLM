...
def test_VisionQwen():
    ...
    batch_size, sequence_length, video_sequence, hidden_size = 1, 120, 256, 768
    ...
    output = model(input_ids=input_ids, position_ids=position_ids, attention_mask=attention_mask, input_vision_ids=input_vision_ids)
